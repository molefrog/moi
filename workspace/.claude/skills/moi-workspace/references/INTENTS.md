...
Use them in user event handlers. Action functions return `void`; `resolveHref` returns a browser href. moi identifies the source applet automatically for chat actions.
