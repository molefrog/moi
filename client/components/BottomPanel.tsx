...
export function BottomPanel({ title, children }: BottomPanelProps) {
  return (
    <motion.div
      className="absolute inset-x-[calc(var(--page-pad)*-1)] bottom-[calc(var(--page-pad)*-1)] z-20 flex max-h-[60vh] flex-col rounded-t-2xl bg-white p-[var(--page-pad)] shadow-[inset_0_0_0_1px_rgba(0,0,0,0.04),inset_0_2px_4px_-1px_rgba(0,0,0,0.06),inset_0_4px_16px_-4px_rgba(0,0,0,0.06)]"
      variants={{
