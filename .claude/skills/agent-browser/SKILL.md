...
> `agent-browser install` cannot download Chrome and the daemon needs
> specific env vars — set up per `docs/browser-testing-cloud.md` before
> using any commands below.
